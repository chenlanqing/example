package com.learning.example.thread.lock.distribute.zookeeper;
...
public class BaseDistributeLock {
    ...
    public BaseDistributeLock(ZkClient client, String basePath, String lockName) {
        this.client = client;
    ...
    protected String attemptLock(long time, TimeUnit unit) throws Exception {
        ...
        while (!isDone) {
            ...
            try {
                ...
                /**
                 * 该方法用于判断自己是否获得锁，即自己创建的顺序节点在locker的所有子节点是否最小，
